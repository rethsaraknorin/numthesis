...
<section class="py-20 bg-gray-50 dark:bg-gray-800/50">
    <div class="container mx-auto px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center gap-12">
            ...
            {{-- Rector's Message --}}
            <div class="md:w-2/3">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white">A Message from Our Rector</h2>
                ...
                <p class="text-xl font-semibold text-gray-900 dark:text-white">Dr. HOR Peng</p>
                <p class="text-md text-gray-500 dark:text-gray-400">Rector</p>
            </div>
        </div>
    </div>
</section>
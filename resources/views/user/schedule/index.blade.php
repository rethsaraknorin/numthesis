        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="space-y-8">
                                ...
                                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    @php
                                        ...
                                        if ($groupShift === 'Weekend') {
                                            ...
                                            // Default for empty schedules
                                            $daysToShow = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];
                                            $shiftsToShow = ['Morning', 'Afternoon', 'Night'];
                                        }
                                    @endphp
                                                ...
                                                <tr class="border-b dark:border-gray-700">
                                                    ...
                                                    @foreach($daysToShow as $dayName)
                                                        <td class="p-2 align-top @if(!$loop->last) border-r dark:border-gray-700 @endif">
                                                            {{-- This is the corrected logic to find the session --}}
                ...
                @else
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                         <div class="p-6 text-center text-gray-500 dark:text-gray-400">
                            You must be an approved student to view a personal schedule.
                        </div>
                    </div>
                @endif
            </div>

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($programs as $program)
                    <div class="bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700 rounded-lg shadow-lg flex flex-col hover:shadow-xl transition-shadow duration-300">
                        <div class="p-6">
                            {{-- Icon --}}
                            <div class="mb-4 text-cyan-500">
                                @if($program->code === 'IT')
                            ...
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $program->name }} ({{$program->code}})</h5>
                            <p class="font-normal text-gray-600 dark:text-gray-400 mb-4 h-20">{{ $program->description }}</p>
                        </div>
                        <div class="mt-auto bg-gray-50 dark:bg-gray-800/50 p-6 rounded-b-lg">

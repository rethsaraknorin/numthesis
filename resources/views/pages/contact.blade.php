...
<head>
    ...
    <title>{{ __('contact_us') }} - National University of Management</title>
    ...
    <main>
        <header class="hero-bg-contact h-96 flex items-center justify-center text-white">
            <div class="text-center">
                <h1 class="text-5xl font-bold">{{ __('contact_us') }}</h1>
                <p class="mt-4 text-xl text-gray-300">{{ __('contact_us_subtitle') }}</p>
            </div>
        </header>
            ...
            <div class="container mx-auto px-6">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div class="lg:col-span-2 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">{{ __('get_in_touch') }}</h2>
                        ...
                        @if (session('success'))
                            <div class="bg-green-100 dark:bg-green-900/50 border-l-4 border-green-500 text-green-700 dark:text-green-300 p-4 mb-6 rounded-md" role="alert">
                                <p class="font-bold">{{ __('contact_form_success') }}</p>
                            </div>
                        @endif
                        ...
                        <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('full_name') }}</label>
                                ...
                                <div>
                                    <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('email_address') }}</label>
                    ...
                    <div class="space-y-8">
                        <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">{{ __('contact_information') }}</h3>
                            <div class="space-y-4 text-gray-600 dark:text-gray-300">
                                ...
                                <p class="flex items-center">
                                    ...
                                    <a href="mailto:chhayphang@num.edu.kh" class="hover:underline">chhayphang@num.edu.kh</a>
                                </p>
                            </div>
                        </div>

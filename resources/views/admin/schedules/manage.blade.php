                    ...
                    <form method="POST" action="{{ route('admin.schedules.store', ['program' => $program, 'year' => $year, 'semester' => $semester]) }}" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                ...
                                <select required name="course_id" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                            ...
                            <div><x-input-label for="lecturer_name" value="Lecturer" /><x-text-input required name="lecturer_name" class="mt-1 block w-full" :value="old('lecturer_name')" /></div>
                            <div><x-input-label for="room_number" value="Room" /><x-text-input required name="room_number" class="mt-1 block w-full" :value="old('room_number')" /></div>
                            <div><x-input-label for="promotion_name" value="Promotion" /><x-text-input required name="promotion_name" class="mt-1 block w-full" :value="old('promotion_name', $activePromotion)" /></div>
                            <div><x-input-label for="group_name" value="Group" /><x-text-input required name="group_name" class="mt-1 block w-full" :value="old('group_name')" /></div>
                            <div>
                                <x-input-label for="day_of_week" value="Day of Week" />
                                <select required name="day_of_week" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                                    @foreach($days as $day)
                            ...
                            <div>
                                ...
                                <select required name="shift" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                            ...
                            <div><x-input-label for="start_time" value="Start Time" /><x-text-input required name="start_time" type="time" class="mt-1 block w-full" :value="old('start_time')" /></div>
                            <div><x-input-label for="end_time" value="End Time" /><x-text-input required name="end_time" type="time" class="mt-1 block w-full" :value="old('end_time')" /></div>
                        </div>

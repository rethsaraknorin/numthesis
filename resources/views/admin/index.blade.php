<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- UPDATED: Grid layout changed to 4 columns and new card added --}}
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {{-- Total Programs Card (Course count removed) --}}
                ...
                {{-- NEW: Total Courses Card --}}
                <div class="bg-green-100 dark:bg-green-900/50 border border-green-200 dark:border-green-800 overflow-hidden shadow-sm rounded-lg p-6 flex flex-col justify-between">
                    <div>
                       <div class="flex items-center justify-between">
                          <h3 class="text-lg font-medium text-green-800 dark:text-green-300">Total Courses</h3>
                       ...
                       <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-gray-100">{{ $totalCourses }}</p>
                   </div>
                    <a href="{{ route('admin.programs.index') }}" class="text-sm font-medium text-green-700 dark:text-green-200 hover:underline mt-4 self-start">Manage Courses &rarr;</a>
               </div>

...
<div class="space-y-8">
    <div class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-xl shadow-lg p-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <img src="{{ asset('assets/logo/num-logo.png') }}" alt="NUM Logo" class="w-24 h-24 md:w-32 md:h-32 rounded-full shadow-lg border-4 border-white hidden md:block">
    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach($featuredPrograms as $program)
                        <a href="{{ route('programs.show', $program) }}" class="block p-5 bg-gray-50 dark:bg-gray-700/50 rounded-lg shadow hover:shadow-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/50 transition group">
